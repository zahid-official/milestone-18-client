...
import { createVendor } from "@/services/vendor/vendorManagement";
import getFieldError from "@/utils/getFieldError";
import { useActionState, useEffect, useState } from "react";

interface UserManagementCreateVendorDialogProps {
  open: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

const UserManagementCreateVendorDialog = ({
  open,
  onClose,
  onSuccess,
}: UserManagementCreateVendorDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-lg max-w-[calc(100%-1.5rem)]">
        <DialogHeader>
          <DialogTitle className="pb-2">Create Vendor</DialogTitle>
        </DialogHeader>
...
export default UserManagementCreateVendorDialog;
